...
<body>
	<div class="container">
		...
		<table>
			...
			<tbody>
				<%
				String query2 = "SELECT e.enrollment_id AS 'Enrollment ID', s.student_id AS 'Student ID', s.first_name AS 'Student First Name', s.last_name AS 'Student Last Name',  c.course_id AS 'Course ID', c.course_name AS 'Course Name', e.enrollment_date AS 'Enrollment Date' FROM Enrollments e JOIN Students s ON e.student_id = s.student_id JOIN Courses c ON e.course_id = c.course_id";
				...
				try {
					...
					while (rs.next()) {
						int Enrollment_ID = rs.getInt("Enrollment ID");
						...
						String Enrollment_Date = rs.getString("Enrollment Date");

						// Output the results in HTML table
						out.println("<tr>");
						out.println("<td>" + Enrollment_ID + "</td>");
						...
						out.println("<td>" + Enrollment_Date + "</td>");
						out.println("</tr>");
					}
